...
export default function Toepassingen() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI Toepassingen - AI Dagelijks</title>
        <meta name="description" content="Ontdek praktische AI-toepassingen in verschillende sectoren en industrieën." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI Toepassingen</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Ontdek hoe AI wordt toegepast in verschillende sectoren, 
            van gezondheidszorg en financiën tot onderwijs en overheid.
          </p>
        </div>
