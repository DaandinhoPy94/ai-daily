...
export default function MilitairCyber() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI in Militair & Cyber - AI Dagelijks</title>
        <meta name="description" content="Ontwikkelingen in militaire AI-toepassingen en cyberveiligheid." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI in Militair & Cyber</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Volg ontwikkelingen in militaire AI-toepassingen en cyberveiligheid, 
            van autonome wapensystemen tot AI-gedreven verdedigingsstrategieën.
          </p>
        </div>
