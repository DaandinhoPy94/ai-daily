...
export default function OverheidPubliekeSector() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI in Overheid & Publieke Sector - AI Dagelijks</title>
        <meta name="description" content="Hoe overheden AI inzetten voor veiligheid, administratie en publieke dienstverlening." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI in Overheid & Publieke Sector</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Volg hoe overheden wereldwijd AI implementeren in veiligheid, administratie, 
            defensie en publieke dienstverlening.
          </p>
        </div>
