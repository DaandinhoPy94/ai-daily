...
export default function CultuurSamenleving() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI Cultuur & Samenleving - AI Dagelijks</title>
        <meta name="description" content="De maatschappelijke impact van AI op cultuur, creativiteit en het publieke debat." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI Cultuur & Samenleving</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Ontdek de maatschappelijke impact van AI op cultuur en samenleving, 
            van creativiteit en kunst tot het publieke debat rond kunstmatige intelligentie.
          </p>
        </div>
