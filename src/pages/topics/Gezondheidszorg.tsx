...
export default function Gezondheidszorg() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI in de Gezondheidszorg - AI Dagelijks</title>
        <meta name="description" content="Ontdek hoe AI de gezondheidszorg transformeert, van diagnostiek tot behandeling." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI in de Gezondheidszorg</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Volg hoe kunstmatige intelligentie de gezondheidszorg revolutioneert, 
            van medische diagnostiek tot gepersonaliseerde behandelingen en robotchirurgie.
          </p>
        </div>
