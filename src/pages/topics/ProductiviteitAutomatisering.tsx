...
export default function ProductiviteitAutomatisering() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI Productiviteit & Automatisering - AI Dagelijks</title>
        <meta name="description" content="Hoe AI de productiviteit verhoogt en processen automatiseert in kantoren en bedrijven." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI Productiviteit & Automatisering</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Ontdek hoe AI de productiviteit transformeert door automatisering, 
            van kantoorsoftware en no-code platforms tot procesoptimalisatie.
          </p>
        </div>
