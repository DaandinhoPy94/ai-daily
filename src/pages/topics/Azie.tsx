...
export default function Azie() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI in Azië - AI Dagelijks</title>
        <meta name="description" content="AI-ontwikkelingen in Azië, van China en Japan tot Zuid-Korea en Singapore." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI in Azië</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Ontdek AI-ontwikkelingen in Azië, van China's AI-ambitie en Japan's robotica 
            tot Zuid-Korea's technologie-innovaties en Singapore's smart city initiatieven.
          </p>
        </div>
