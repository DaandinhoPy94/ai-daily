...
export default function OnderwijsTraining() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>AI in Onderwijs & Training - AI Dagelijks</title>
        <meta name="description" content="Hoe AI het onderwijs transformeert, van AI-docenten tot gepersonaliseerd leren." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">AI in Onderwijs & Training</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Ontdek hoe kunstmatige intelligentie het onderwijs revolutioneert, 
            van AI-docenten en gepersonaliseerd leren tot e-learning platforms en adaptieve educatie.
          </p>
        </div>
