...
SELECT '7e1c2c0a-bfd6-46da-bf4b-6f78f9b3e7c2'::uuid, 
...
SELECT '51d5c8eb-8a87-42d6-b405-3f1af5d7acbb'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT 'b2c97a10-8f78-4c63-9e4a-d8e9c3d70f9e'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT '63adf52d-9bc2-4c2f-a56e-01b78c6c6fd2'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT 'f61c68d1-0d91-4762-90fc-b5b36d23cb8a'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT '9f15a6d0-cc9d-4b0c-b0f4-fc13f5b9c91b'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT '3f07bb32-08d8-46a2-b28f-8db9a95d9d57'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT '8d4b3f5c-5c12-4b8f-9f34-8b20d77b3ae7'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT '4e19f8a6-1c1e-4d6c-8b23-2b58942c7a3b'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT 'f32cb9a8-6c3b-49f5-a87f-97c13a48b04d'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
...
SELECT 'b89c12e1-40ad-4f2a-91f6-6a4eab7ef41d'::uuid, 
       now() - (random() * interval '5 days'), 
       encode(gen_random_bytes(16), 'hex'),
       'Mozilla/5.0 (compatible; NewsBot/1.0)'
