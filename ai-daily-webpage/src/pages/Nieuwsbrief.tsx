...
export default function Nieuwsbrief() {
  ...
  const content = (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>Nieuwsbrief - AI Dagelijks</title>
        <meta name="description" content="Blijf op de hoogte van het laatste AI-nieuws met onze wekelijkse nieuwsbrief." />
      </Helmet>
      
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">Nieuwsbrief</h1>
          <p className="text-lg text-muted-foreground mb-8 text-center">
            Ontvang wekelijks de belangrijkste AI-ontwikkelingen in je inbox
          </p>
          ...
          <Card className="border-dashed border-2">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-xl">Binnenkort nieuwsbrief</CardTitle>
            </CardHeader>
            <CardContent className="text-center space-y-4">
              <p className="text-muted-foreground">
                We werken hard aan een wekelijkse nieuwsbrief met de belangrijkste AI-ontwikkelingen, samengevat en geanalyseerd door onze redactie.
              </p>
              <p className="text-muted-foreground">
